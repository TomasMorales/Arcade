...
function cronometro() {
  if(segundos==11 && contador==2){
    ...
    document.getElementById('meme2').setAttribute('href','Index.html');
    document.getElementById('meme1').style.backgroundImage= "url('images/CLINTON/frase.jpg')";
  ...
  if (segundos < 999999 && contador==0) {
    if (juego.checkGanador()==true && contador==0) {
      ...
      himno.pause();
      document.getElementById('texto').innerHTML="The Turd Sandwich won the elections :)"; 
      reinicio();
      inicio();
    }
  }
  if (segundos==10 && contador==1) {
        document.getElementById('body').style.backgroundImage="url('images/CLINTON/casaBlanca.jpg')";
        ...
        document.getElementById('texto').innerHTML="Everyone when Hillary wins elections"; 
        var video = document.getElementById("VIDEO");
        video.setAttribute("src","videos/theOffice.mp4");
...
var juego = {
  ...
  crearPieza(numero,fila,columna){
    ...
    if (numero<9) {
      ...
      nuevoElemento.css({
        backgroundImage:'url(images/CLINTON/' + numero + '.jpeg)',
        top: fila * 200,
        left: columna * 200,
      });
