...
var centesimas = 0;
var segundos = 0;
var himno = new Audio('sonidos/URSS.ogg');
var contador = 0;
...
function cronometro() {
  if(segundos==31 && contador==2){
    ...
    document.getElementById('meme1').style.backgroundImage= "url('images/URSS/vladimirPutin.jpg')";
  ...
  if (segundos < 999999 && contador==0) {
    if (juego.checkGanador()==true && contador==0) {
      ...
      himno.pause();
      document.getElementById('texto').innerHTML="эндоплазматической сети :)"; 
      reinicio();
      inicio();
    }
  }
  if (segundos==10 && contador==1) {
        document.getElementById('body').style.backgroundImage="url('images/URSS/facepalmURSS.jpg')";
        ...
        document.getElementById('texto').innerHTML="Да здравствует родина.Товарищ. (The Little Red is happy)"; 
        var video = document.getElementById("VIDEO");
        video.setAttribute("src","videos/simpsons.mp4");
...
var juego = {
  ...
  crearPieza(numero,fila,columna){
    ...
    if (numero<9) {
      ...
      nuevoElemento.css({
        backgroundImage:'url(images/URSS/' + numero + '.jpeg)',
        top: fila * 200,
        left: columna * 200,
      });
