...
var centesimas = 0;
var segundos = 0;
var himno = new Audio('sonidos/USA.ogg');
var contador = 0;
...
function cronometro() {
  if(segundos==28 && contador==2){
    parar();
    document.getElementById('VIDEO').style.display = "none";
    document.getElementById('texto').style.backgroundColor = "black";
    document.getElementById('texto').style.color= "white";
    document.getElementById('texto').innerHTML="Contempló el enorme rostro. Le había costado años saber qué clase de sonrisa era aquella oculta bajo el peliquin rubio. ¡Qué cruel e inútil incomprensión! ¡Qué tozudez la suya exilándose a sí mismo de aquel corazón amante! Dos lágrimas, perfumadas de ginebra, le resbalaron por las mejillas. Pero ya todo estaba arreglado, todo alcanzaba la perfección, la lucha había terminado. Se había vencido a sí mismo definitivamente. Amaba a Donlad Trump. Gracias por JUGAR";
    document.getElementById('meme2').style.backgroundImage= "url('images/Morfeo/Watchmen.jpeg')";
    document.getElementById('meme2').style.width="765px";
    document.getElementById('meme2').style.height="129px";
    document.getElementById('meme2').style.backgroundPosition="center";
    document.getElementById('meme2').style.margin="auto";
    document.getElementById('meme1').style.backgroundImage= "url('images/USA/donaldTrump.jpg')";
    document.getElementById('meme1').style.width="850px";
    document.getElementById('meme1').style.height="400px";
  ...
  if (segundos < 999999 && contador==0) {
    if (juego.checkGanador()==true && contador==0) {
      ...
      himno.pause();
      document.getElementById('texto').innerHTML="You make America great Again :)"; 
      reinicio();
      inicio();        
    }
  }
  if (segundos==10 && contador==1) {
        document.getElementById('body').style.backgroundImage="url('images/USA/fondoUSA.jpg')";
        ...
        document.getElementById('texto').innerHTML="This will happen when donald trump be the president of America"; 
        var video = document.getElementById("VIDEO");
        video.setAttribute("src","videos/terminator2.mp4");
        video.setAttribute("width", "1024");
        video.setAttribute("height", "364");
...
var juego = {
  pos:[[],[]],
    ...
    if (numero<9) {
      ...
      nuevoElemento.css({
        backgroundImage:'url(images/USA/' + numero + '.jpeg)',
        top: fila * 200,
        left: columna * 200,
      });
